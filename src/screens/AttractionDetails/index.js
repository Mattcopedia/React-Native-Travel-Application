...
const tokenmapbox = "pk.eyJ1Ijoib2ZlaW11biIsImEiOiJjbGY4amt0ZzQwM2FyM3hvMzNyendwMDgzIn0.6RJtQTHcs309DS01kKzAvQ"
...
${item?.opening_time} - ${item?.closing_time}`;
    ...
    return (
        ...
        <MapboxGL.MapView style={styles.map}>
            <MapboxGL.Camera zoomLevel={6} centerCoordinate={coordinateExample} />
            <MapboxGL.PointAnnotation id="pointer" title="mab" coordinate={coordinateExample} />
           </MapboxGL.MapView>  
